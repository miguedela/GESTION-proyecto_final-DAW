        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500">
          ...
          <tbody>
            {restaurants.content.length === 0 && (
              <tr className="bg-white border-b border-neutral-800 hover:bg-gray-50">
                <td colSpan={6} className="px-6 py-4 text-center">No tienes restaurantes asignados.</td>
              </tr>
            )}
            {restaurants.content.map((restaurant) => (
              <tr key={restaurant.id} className="bg-white border-b border-neutral-800 hover:bg-gray-50">
